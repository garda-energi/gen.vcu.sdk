...
type StructReportPacket struct {
...
func (r *StructReportPacket) ValidPrefix() bool {
	if r.Header == nil {
		return false
	}
...
func (r *StructReportPacket) Size() int {
	validSize := getPacketSize(r) - 3
	return validSize
}

// ValidSize check if r's size is valid
func (r *StructReportPacket) ValidSize() bool {
	if r.Header == nil {
		return false
	}
...
func (r *StructReportPacket) String() string {
	var out string
